...
//       toast.error("Error connecting wallte", error);
//     }
//   };
...
//       await tx.wait();
//       toast.success("Booster bought successfully");
//       console.log("Booster bought successfully");
//     } catch (error) {
//       console.error("Error buying booster:", error);
//       toast.error("Error buying booster: " + error.message);
//     }
//   }
...
//       <Navbar/>
//       {/* <Navbar/> */}
//       <section class="bg-bgg relative isolate dark:bg-bgg">
    ...
    <div>
      ...
      <section class="bg-bgg relative isolate dark:bg-bgg">
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
              Access exclusive perks, bonuses, or privileges tailored to the
              selected pricing tier.
            </h2>
            <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
              Amplify your earning potential and enjoy a more rewarding
              experience with our diverse pricing plans.
            </p>
          </div>
          <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-bgg1 dark:text-white">
              <h3 class="mb-4 text-2xl font-semibold">Starter</h3>
              <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                Best option for initial boost in your coins.
              </p>
              <div class="flex justify-center items-baseline my-8">
                <span class="mr-2 text-5xl font-extrabold">150 INC</span>
                <span class="text-gray-500">/month</span>
              ...
              <ul role="list" class="mb-8 space-y-4 text-left">
                <li class="flex items-center space-x-3">
                  ...
                  <span>
                    Duration: <span class="font-semibold">15 days</span>
                  </span>
                </li>
                <li class="flex items-center space-x-3">
                  <svg
                  ...
                  <span>
                    Get Additional:{" "}
                    <span class="font-semibold">5 coins per game</span>
                  </span>
                </li>
              </ul>
              <button
            ...
            <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-bgg1 dark:text-white">
              <h3 class="mb-4 text-2xl font-semibold">Company</h3>
              <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                Relevant for faster growth, extended & premium support.
              </p>
              <div class="flex justify-center items-baseline my-8">
                <span class="mr-2 text-5xl font-extrabold">300 INC</span>
                <span class="text-gray-500 ">/month</span>
              ...
              <ul role="list" class="mb-8 space-y-4 text-left">
                <li class="flex items-center space-x-3">
                  ...
                  <span>
                    Duration: <span class="font-semibold">30 days</span>
                  </span>
                </li>
                <li class="flex items-center space-x-3">
                  <svg
                  ...
                  <span>
                    Get Additional:{" "}
                    <span class="font-semibold">10 coins per game</span>
                  </span>
                </li>
              </ul>
              <button
            ...
            <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-bgg1 dark:text-white">
              ...
              <div class="flex justify-center items-baseline my-8">
                <span class="mr-2 text-5xl font-extrabold">450 INC</span>
                <span class="text-gray-500 ">/month</span>
              </div>
              ...
              <ul role="list" class="mb-8 space-y-4 text-left">
                ...
                <li class="flex items-center space-x-3">
                  ...
                  <span>
                    Duration: <span class="font-semibold">45 days</span>
                  </span>
                </li>
                <li class="flex items-center space-x-3">
                  <svg
                  ...
                  <span>
                    Get Additional:{" "}
                    <span class="font-semibold">20 coins per game</span>
                  </span>
                </li>
              </ul>
              <button
